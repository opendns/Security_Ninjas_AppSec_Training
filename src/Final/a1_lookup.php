				...
				<article id="contact" class="container small">
					...
					<div>
						<div class="row">
							<div class="12u">
							<ul>
								<li><H5 style="cursor: pointer" onclick="DisplayHintOrSolution('a1h1');"> Hint 1 </H5><p id="a1h1"></p></li>
								<li><H5 style="cursor: pointer" onclick="DisplayHintOrSolution('a1h2');"> Hint 2 </H5><p id="a1h2"></p></li>
								<li><H5 style="cursor: pointer" onclick="DisplayHintOrSolution('a1s');"> Solution </H5><p id="a1s"></p></li>
							</ul>
							</div>
						</div>
					</div>
